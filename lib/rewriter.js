...
Rewriter.prototype.rewrite = function(modules) {
  ...
  // FIXME: This is just here to ensure that all exports know where they came
  // from. We need this because after we re-write the declarations will not be
  // there anymore and we'll need to ensure they're cached up front.
  modules.forEach(function(mod) {
    mod.exports.declarations.forEach(function(declaration) {
