...
CommonJSFormatter.prototype.buildExports = function(mod) {
  ...
  var Object_seal = b.memberExpression(
    b.identifier('Object'),
    b.identifier('seal'),
    false
  );
  ...
  return b.expressionStatement(
    b.sequenceExpression(assignments.concat([
      b.logicalExpression(
        '&&',
        Object_seal,
        b.callExpression(
...
CommonJSFormatter.prototype.processExportReassignment = function(mod, nodePath) {
  throw new Error(
    "Reassignment of exported values is not allowed when targeting ES3: " +
    sourcePosition(mod, nodePath.node)
  );
};
