...
(function() {
  ...
  var AbstractCompiler, CompileError, INDENT, OUTDENT,
  ...
  AbstractCompiler = (function() {
    ...
    AbstractCompiler.prototype.indent = function(output) {
      return output.push(INDENT);
    };

    AbstractCompiler.prototype.outdent = function(output) {
      return output.push(OUTDENT);
    };

    AbstractCompiler.prototype.buildStringFromLines = function(lines) {
      var indent, line, result, _i, _len;
      indent = 0;
      result = [];
