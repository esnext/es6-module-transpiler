...
},{"./compiler":2,"./script_builder":3}],2:[function(require,module,exports){
"use strict";
...
},{"./amd_compiler":4,"./cjs_compiler":5,"./globals_compiler":6,"./utils":7}],3:[function(require,module,exports){
(function(){"use strict";
...
},{"./abstract_compiler":10,"./utils":7,"path":9}],5:[function(require,module,exports){
"use strict";
var $__superDescriptor = function(proto, name) {
  if (!proto) throw new TypeError('super is null');
  return Object.getPropertyDescriptor(proto, name);
...
},{"./abstract_compiler":10}],6:[function(require,module,exports){
(function(){"use strict";
var $__superDescriptor = function(proto, name) {
  if (!proto) throw new TypeError('super is null');
  return Object.getPropertyDescriptor(proto, name);
...
},{"./abstract_compiler":10,"./utils":7}],10:[function(require,module,exports){
"use strict";
var $__getDescriptors = function(object) {
  var descriptors = {}, name, names = Object.getOwnPropertyNames(object);
  for (var i = 0; i < names.length; i++) {
...
},{"./coffee_script_builder":12,"./compile_error":13,"./java_script_builder":11,"./utils":7}],13:[function(require,module,exports){
"use strict";
var $__superDescriptor = function(proto, name) {
  if (!proto) throw new TypeError('super is null');
  return Object.getPropertyDescriptor(proto, name);
...
},{"./script_builder":3}],12:[function(require,module,exports){
"use strict";
var $__superDescriptor = function(proto, name) {
  if (!proto) throw new TypeError('super is null');
  return Object.getPropertyDescriptor(proto, name);
